...
type Repository interface {
	...
	Search(ctx context.Context, storage Data, keyword string) (*mongo.Cursor, error)
}
...
func Search(ctx context.Context, storage Data, keyword string) (*mongo.Cursor, error) {
	filter := bson.M{
		"$or": []bson.M{
